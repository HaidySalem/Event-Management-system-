...
//        Customer customer = new Customer(userID, name, email, phone, password, "Models.Customer");
...
//                        Models.EventDetails event = new Models.EventDetails(EventType, FormDate, time, guestcount, venue, addServ, spReq);
